  ...
  return (
    <div className='group relative'>
      <div onClick={handleDetails} className='w-full h-96 cursor-pointer overflow-hidden'>
        <img src={product.image} alt="imageofproduct" className='w-full h-full object-cover group-hover:scale-110 duration-500 gap-4' />
      </div>
      <div className='w-full border-[1px] px-2 py-4'>
       <div className='flex justify-between items-center'>
       <div>
          <h2 className='text-base font-semibold'>{product.title.substring(0,15)}</h2>
        </div>
